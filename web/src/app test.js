...
const behavioralInsights = (userData && analysis) ? generateBehavioralInsights(userData, analysis, activityEvents) : [];
    ...
    <>
      {/* Animated Mirror Background */}
                       <StarBackground>
        <TwinklingStar top="20%" left="15%" size="1.2rem" duration="2s" delay="0s">⭐</TwinklingStar>
        <TwinklingStar top="30%" left="85%" size="0.8rem" duration="2.5s" delay="0.8s">✨</TwinklingStar>
        <TwinklingStar top="70%" left="25%" size="1rem" duration="3s" delay="1.5s">🌟</TwinklingStar>
        <TwinklingStar top="60%" left="75%" size="0.9rem" duration="2.2s" delay="0.3s">⭐</TwinklingStar>
        <TwinklingStar top="85%" left="60%" size="1.1rem" duration="2.8s" delay="1.2s">✨</TwinklingStar>
      </StarBackground>
